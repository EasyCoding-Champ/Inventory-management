...
import loginLogo from "../../assets/Bhawani.png";
...
function DashBoardLayout() {
  ...
  <div className="relative">
    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-24 text-center text-white p-4">
      <Link
        to={"auth"}
        className="px-6 py-2 animate-pulse rounded-md text-lg 
